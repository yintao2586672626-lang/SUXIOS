...
final class ManualNotificationServiceTest extends TestCase
{
    ...
    public function testThreeSourceHourlyCloudPlanSupportsMidnightCloseout(): void
    {
        Db::name('competitor_wechat_robot')->insert([
            'id' => 32,
            'store_id' => 80,
        ...
        $midnight = (new ManualNotificationService())->save(
            9,
            80,
            7,
            '敦煌漠蓝新',
        ...
        self::assertSame('00:00', $midnight['record']['hourly_start_time']);
        self::assertSame('awaiting_test', $midnight['record']['schedule_status']);
    }
    ...
    public function testOneAmHourlyPlanAcceptsOnlyItsMidnightWindowMigrationFingerprint(): void
    {
        ...
        $midnightFingerprints =
            ManualNotificationService::acceptedPlanFingerprints($midnightVersion);
        ...
        $sameTestedPlan = new \ReflectionMethod(
            ManualNotificationService::class,
            'sameTestedPlan'
        );
        self::assertTrue($sameTestedPlan->invoke(
            new ManualNotificationService(),
            $plan,
            $midnightVersion
        ));
        self::assertFalse($sameTestedPlan->invoke(
            new ManualNotificationService(),
            $plan,
            [...$midnightVersion, 'body' => 'changed payload']
        ));
    }
