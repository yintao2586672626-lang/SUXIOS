...
final class RevenueAiOverviewServiceTest extends TestCase
{
    ...
    public function testFloorPriceMissingResolutionSpecRequiresExplicitGuardInput(): void
    {
        ...
        $method = new \ReflectionMethod($service, 'pricingAiDecisionResolutionSpec');
        $resolution = $method->invoke($service, 'floor_price', 'floor_price_missing');

        self::assertSame('provide_floor_price_or_min_rate_guard', $resolution['resolution_action']);
        self::assertSame('pricing_guard_review', $resolution['unblocks']);
        self::assertSame('approve_price_without_floor_guard', $resolution['forbidden_shortcut']);
    }
