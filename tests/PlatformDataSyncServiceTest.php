...
final class PlatformDataSyncServiceTest extends TestCase
{
    ...
    public function testBrowserProfileBackgroundSyncRejectsHistoricalStatusWithoutReusableProof(): void
    {
        $service = new PlatformDataSyncService();
    ...
    public function testBrowserProfileBackgroundSyncReportsHistoricalStatusWithoutProofAsUnverified(): void
    {
        $service = new PlatformDataSyncService();
    ...
    public function testBrowserProfileBackgroundSyncRejectsManualLoginFlagWithoutReusableProof(): void
    {
        $service = new PlatformDataSyncService();
        $method = new \ReflectionMethod($service, 'assertBrowserProfileBackgroundSyncLoginVerified');
        $method->setAccessible(true);
