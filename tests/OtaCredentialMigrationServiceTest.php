...
final class OtaCredentialMigrationServiceTest extends TestCase
{
    ...
    public function testHistoricalSupersededMetadataRequiresCredentialReentry(): void
    {
        Db::name('system_configs')->insert([
            ...
            'config_value' => $this->json([
                'legacy-superseded' => [
                    ...
                    'config_id' => 'legacy-superseded',
                    'hotel_id' => 10,
                    'system_hotel_id' => 10,
                    'credential_status' => 'superseded',
                    'has_cookies' => false,
                    'superseded_by_config_id' => 'legacy-canonical',
                ],
            ]),
        ]);
        ...
        self::assertSame('migration_required', $summary['status']);
        self::assertSame(1, $summary['inventory_count']);
        self::assertSame(1, $summary['classification_counts']['unbound']);
        self::assertSame('superseded_credential_requires_reentry', $summary['items'][0]['reason_code']);
        self::assertSame(0, (int)Db::name('ota_credentials')->count());
    }
