...
return [
    ...
    'commands' => [
        ...
        'operation:scheduled-reviews' => 'app\command\ReviewScheduledExecutions',
        'operation:prepare-daily' => 'app\command\PrepareDailyOperating',
        'operation:prepare-weekly' => 'app\command\PrepareWeeklyOperatingPlan',
