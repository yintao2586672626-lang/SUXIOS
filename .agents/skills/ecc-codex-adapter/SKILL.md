...
description: Use when a task mentions ECC, Everything Claude Code, Claude Code workflows, Codex adaptation, Codex plugins, ECC skills, ECC rules, or converting Claude Code assets for SUXIOS Codex use.
---
