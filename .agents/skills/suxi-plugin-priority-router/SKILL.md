...
description: Route SUXIOS tasks to installed Codex plugins and connectors before local/manual work. Use when a request mentions plugins, connectors, Chrome, GitHub, Computer Use, Figma, Documents, Presentations, Spreadsheets, HyperFrames, Remotion, Canva, Browser, Cloudflare, Data Analytics, Google Drive, OpenAI Developers, Sentry, skill library improvement, or plugin-first skill behavior.
---
