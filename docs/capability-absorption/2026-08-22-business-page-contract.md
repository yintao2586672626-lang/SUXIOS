...
- 2026-08-22 首次登记时，旧策略、开业、扩张、投决和生命周期页面按 `frozen_hidden + baseline` 登记，保留当时的已知限制；
...
- 开业总览、开业检查清单和酒店量化模拟已具备可发现入口、酒店范围、保存回读及人工待审批合同，升级为 `active + strict`；
- 策略、可研、扩张、资产定价、正式投决与全生命周期继续保持 `frozen_hidden + baseline`；
- 本次升级只提高代码级合同成熟度，不代表真实开业项目、投资情景或生产现场已经 `field_validated`。
