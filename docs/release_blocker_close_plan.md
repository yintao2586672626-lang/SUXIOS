...
Current status: `codex-security-scan-missing` is closed by `docs/security/codex-security/latest` and `npm run review:release-security-scan`; the other release blockers remain open.
