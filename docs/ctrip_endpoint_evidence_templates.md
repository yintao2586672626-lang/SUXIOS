...
| 候选方向 | 数据类型 | 状态 | 过滤关键词 |
|---|---|---|---|
| 经营报告-流量数据 (traffic_report) | traffic | missing_evidence | queryflowtransfornewv1, queryflowtransformnewv1, queryflowtransfernewv1, fetchcurrenthotelseqinfov1, queryscanflowdetailsv2, queryflowsource, flowdata, traffic |
...
- 在 DevTools Network 中过滤这些关键词：queryflowtransfornewv1, queryflowtransformnewv1, queryflowtransfernewv1, fetchcurrenthotelseqinfov1, queryscanflowdetailsv2, queryflowsource, flowdata, traffic。
