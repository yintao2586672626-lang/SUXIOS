...
> 2026-07-11 当前状态：酒店图片优化功能及 `public/hotel-image-optimizer-static.js` 已在第一轮范围收缩中删除。下文相关内容仅保留为历史拆分记录，不代表当前仍有该入口或能力。
...
## 2026-06-12 保存点：平台自动获取配置预热后置与状态显式化
