...
|---|---:|---|---|
| `public/index.html` | 1,407 个函数级块；44 个 `currentPage` 引用 | `startAiAnalysis` 127 行、`recheckCtripProfileMismatchedFields` 108 行、`runCtripBrowserCapture` 105 行 | `general` 7,165 行、`ctrip` 3,472 行、`hotel_admin` 1,289 行、`ai` 1,228 行、`meituan` 1,205 行、`ota` 479 行 |
