...
final class OperatingOpportunityLabService
{
    ...
    private function saveRun(
        ...
        if (!hash_equals($inputDigest, (string)$readback['input_digest'])
            || !hash_equals($resultDigest, (string)$readback['result_digest'])
            || (int)$readback['system_hotel_id'] !== $hotelId
    ...
    private function digest(array $value): string { return hash('sha256', $this->encodeJson($value)); }
