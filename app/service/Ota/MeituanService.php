...
final class MeituanService
{
    ...
    {
        return $this->dispatcher->dispatch(OtaDomain::MEITUAN, $action, $this->handler, $arguments);
    }

    /** @return list<string> */
    public function actions(): array
    {
        return OtaActionCatalog::actionsFor(OtaDomain::MEITUAN);
    }
}
