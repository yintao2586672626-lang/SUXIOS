...
final class CtripService
{
    ...
    {
        return $this->dispatcher->dispatch(OtaDomain::CTRIP, $action, $this->handler, $arguments);
    }

    /** @return list<string> */
    public function actions(): array
    {
        return OtaActionCatalog::actionsFor(OtaDomain::CTRIP);
    }
}
