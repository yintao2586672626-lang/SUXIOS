...
CREATE TABLE `hotels` (
  ...
  `status` TINYINT DEFAULT 1 COMMENT '状态: 1启用 0禁用',
  `archived_at` DATETIME NULL COMMENT '归档时间；归档后停止访问与采集但保留历史数据',
  `archived_by` INT UNSIGNED NULL COMMENT '执行归档的管理员ID',
...
INSERT INTO `hotels` (`id`,`name`,`code`,`address`,`contact_person`,`contact_phone`,`status`,`archived_at`,`archived_by`,`description`,`ota_channel_strategy`,`created_by`,`create_time`,`update_time`) VALUES
(1, '南宁市银田酒店', 'YINTIAN', '', '', '', 1, NULL, NULL, '', 'dual', 2, '2026-02-24 09:15:46', '2026-02-26 18:06:49.965114'),
(2, '西湖度假村', 'XH002', '杭州市西湖区', '李经理', '0571-87654321', 1, NULL, NULL, NULL, 'dual', 4, '2026-02-24 09:15:46', '2026-02-24 09:15:46'),
(3, '海滨国际酒店', 'HB003', '上海市浦东新区', '王经理', '021-11112222', 1, NULL, NULL, NULL, 'dual', 0, '2026-02-24 09:15:46', '2026-02-24 09:15:46'),
(4, '东方大酒店', 'DF001', '北京市朝阳区', '张经理', '010-12345678', 1, NULL, NULL, NULL, 'dual', 0, '2026-02-27 08:59:40', NULL);
