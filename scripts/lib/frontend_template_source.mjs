...
export const FRONTEND_TEMPLATE_FRAGMENT_DEFINITIONS = Object.freeze([
  ...
  { id: 'page-compass-ai-workbench', domain: 'decision-workbench', path: 'fragments/23-page-compass-ai-workbench.html', anchor: '<div v-if="currentPage === \'ai-workbench\' || currentPage === \'compass\'" class="compass-dashboard suxi-dashboard-scope">' },
