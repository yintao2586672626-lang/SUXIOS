...
export const FRONTEND_TEMPLATE_FRAGMENT_DEFINITIONS = Object.freeze([
  ...
  { id: 'page-operating-targets', domain: 'operations', path: 'fragments/15aa-page-operating-targets.html', anchor: '<div v-if="currentPage === \'operating-targets\'" class="mx-auto max-w-7xl space-y-4" data-testid="operating-target-page">' },
  { id: 'page-pms-operating-data', domain: 'operations', path: 'fragments/15aab-page-pms-operating-data.html', anchor: '<div v-if="currentPage === \'pms-operating-data\'" class="mx-auto max-w-7xl space-y-4" data-testid="pms-operating-data-page">' },
  { id: 'page-automation-run-monitor', domain: 'operations', path: 'fragments/15aac-page-automation-monitor.html', anchor: '<div v-if="currentPage === \'automation-monitor\'" class="suxi-dashboard-scope mx-auto max-w-[1500px] space-y-4" data-testid="automation-run-monitor-page">' },
  { id: 'page-manual-notifications', domain: 'operations', path: 'fragments/15ab-page-manual-notifications.html', anchor: '<div v-if="[\'manual-notifications\', \'wechat-notification\'].includes(currentPage)" class="max-w-7xl mx-auto space-y-6" data-testid="page-manual-notifications">' },
