...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  ...
  { path: 'public/meituan-static.js', max_lines: 5_000, ratchet_max_lines: 5_054, boundary: '2026-09-08 newly inventoried hotspot: reviewed manual-flow scope isolation and stored-history projection; retain the 5000-line target and freeze existing growth pending domain extraction' },
  ...
  { path: 'app/service/OtaLocalCollectorService.php', max_lines: 4_800, ratchet_max_lines: 6_434, boundary: 'pairing, scheduling, result persistence, browser-profile status, and idempotency conflict fencing; duplicate missing-field policy consolidated; zero-growth until another concern extraction' },
  ...
  { path: 'route/app.php', max_lines: 500, ratchet_max_lines: 767, boundary: 'legacy route bootstrap; AI daily reports, Agent guidance, Revenue AI, AI governance, operations, and WeCom including manual notifications domains extracted; zero-growth until the next authenticated domain manifest' },
