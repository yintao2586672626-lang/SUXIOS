...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  ...
  { path: 'public/meituan-static.js', max_lines: 5_000, boundary: 'Meituan request and display helpers; request normalization reuses shared builders; extract domain behavior before exceeding the 5000-line target' },
  ...
  { path: 'app/service/OtaLocalCollectorService.php', max_lines: 4_800, ratchet_max_lines: 6_368, boundary: 'pairing, scheduling, result persistence, browser-profile status, and idempotency conflict fencing; duplicate missing-field policy consolidated; zero-growth until another concern extraction' },
