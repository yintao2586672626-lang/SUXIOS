...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  ...
  { path: 'tests/PlatformDataSyncServiceTest.php', max_lines: 5_000, ratchet_max_lines: 6_020, boundary: 'platform sync integration and current-run evidence contracts; zero-growth until fixture-domain extraction' },
  ...
  { path: 'app/controller/concern/AgentOtaDiagnosisPersistenceConcern.php', max_lines: 1_750, ratchet_max_lines: 2_223, boundary: 'OTA diagnosis persistence including route-version readback; zero-growth until persistence extraction' },
