...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  ...
  { path: 'tests/PlatformDataSyncServiceTest.php', max_lines: 5_000, ratchet_max_lines: 6_283, boundary: 'platform sync integration and current-run evidence contracts; zero-growth until fixture-domain extraction' },
