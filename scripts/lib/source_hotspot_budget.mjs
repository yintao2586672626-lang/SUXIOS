...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  // 2026-08-10 reviewed rebaseline: targets stay unchanged; ratchets freeze the integrated feature baseline so future growth still fails closed.
  { path: 'public/app-main.js', max_lines: 49_934, ratchet_max_lines: 51_957, boundary: 'formal promotion + temporal trial + XLSX verified closure plus authenticated patrol-report export; zero-growth until a behavior-driven domain extraction' },
  ...
  { path: 'app/controller/Agent.php', max_lines: 2_700, ratchet_max_lines: 2_722, boundary: 'Agent OTA concern traits' },
  ...
  { path: 'app/service/PlatformDataSyncService.php', max_lines: 3_800, ratchet_max_lines: 4_167, boundary: 'data source, task, and persistence concerns' },
  ...
  { path: 'app/service/OtaLocalCollectorService.php', max_lines: 4_800, ratchet_max_lines: 5_398, boundary: 'pairing, scheduling, result persistence, and browser-profile status concerns' },
  ...
  { path: 'tests/PlatformDataSyncServiceTest.php', max_lines: 5_000, ratchet_max_lines: 5_912, boundary: 'platform sync integration and current-run evidence contracts; zero-growth until fixture-domain extraction' },
  ...
  { path: 'app/controller/concern/AgentOtaDiagnosisPersistenceConcern.php', max_lines: 1_750, ratchet_max_lines: 2_223, boundary: 'OTA diagnosis persistence' },
