...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  // 2026-08-12 reviewed integration rebaseline: targets stay unchanged; exact ratchets freeze the verified combined feature baseline so future growth still fails closed.
  ...
  { path: 'app/controller/Agent.php', max_lines: 2_700, ratchet_max_lines: 3_212, boundary: 'Agent OTA concern traits' },
  ...
  { path: 'app/service/PlatformDataSyncService.php', max_lines: 3_800, ratchet_max_lines: 4_231, boundary: 'data source, task, and persistence concerns' },
  ...
  { path: 'app/service/OtaLocalCollectorService.php', max_lines: 4_800, ratchet_max_lines: 6_440, boundary: 'pairing, scheduling, result persistence, and browser-profile status concerns' },
  ...
  { path: 'tests/PlatformDataSyncServiceTest.php', max_lines: 5_000, ratchet_max_lines: 5_999, boundary: 'platform sync integration and current-run evidence contracts; zero-growth until fixture-domain extraction' },
  ...
  { path: 'app/command/AutoFetchOnlineData.php', max_lines: 4_000, ratchet_max_lines: 5_204, boundary: 'hotel-scoped collection planning, execution, durable receipts, and owner-safe locking; zero-growth until command orchestration extraction' },
  { path: 'app/controller/concern/AgentOtaExecutionIntentConcern.php', max_lines: 250, boundary: 'Agent execution intents' },
  { path: 'app/controller/concern/AgentCapturedOtaAnalysisConcern.php', max_lines: 2_450, ratchet_max_lines: 2_507, boundary: 'captured OTA analysis' },
  ...
  { path: 'app/controller/concern/AgentOtaDiagnosisPersistenceConcern.php', max_lines: 1_750, ratchet_max_lines: 2_399, boundary: 'OTA diagnosis persistence' },
  ...
  { path: 'app/service/concern/PlatformSyncTaskConcern.php', max_lines: 1_900, ratchet_max_lines: 2_332, boundary: 'platform sync tasks' },
