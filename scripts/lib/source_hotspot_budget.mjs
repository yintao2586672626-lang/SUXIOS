...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  ...
  { path: 'app/controller/Agent.php', max_lines: 2_700, ratchet_max_lines: 2_703, boundary: 'Agent OTA concern traits plus persisted decision-route wiring; zero-growth until route orchestration extraction' },
  { path: 'app/controller/concern/AutoFetchConcern.php', max_lines: 5_200, boundary: 'platform execution concern traits' },
  { path: 'app/service/PlatformDataSyncService.php', max_lines: 3_800, ratchet_max_lines: 3_903, boundary: 'data source, task, persistence, and target-date provenance concerns; zero-growth until another concern extraction' },
  ...
  { path: 'app/service/OtaLocalCollectorService.php', max_lines: 4_800, ratchet_max_lines: 5_394, boundary: 'pairing, scheduling, result persistence, browser-profile status, and idempotency conflict fencing; zero-growth until another concern extraction' },
  ...
  { path: 'tests/PlatformDataSyncServiceTest.php', max_lines: 5_000, ratchet_max_lines: 5_100, boundary: 'platform sync provenance and target-date regressions; zero-growth until fixture extraction' },
  { path: 'app/controller/concern/AgentOtaExecutionIntentConcern.php', max_lines: 250, boundary: 'Agent execution intents' },
  { path: 'app/controller/concern/AgentCapturedOtaAnalysisConcern.php', max_lines: 2_450, ratchet_max_lines: 2_499, boundary: 'captured OTA analysis plus truthful decision-route composition; zero-growth until route service extraction' },
  ...
  { path: 'app/controller/concern/AgentOtaDiagnosisPersistenceConcern.php', max_lines: 1_750, ratchet_max_lines: 1_884, boundary: 'OTA diagnosis persistence including route-version readback; zero-growth until persistence extraction' },
