...
export const SOURCE_HOTSPOT_BUDGETS = Object.freeze([
  ...
  { path: 'route/app.php', max_lines: 500, ratchet_max_lines: 785, boundary: 'legacy route bootstrap; AI daily reports, Agent guidance, AI governance, operations, and WeCom domains extracted; zero-growth until the next authenticated domain manifest' },
