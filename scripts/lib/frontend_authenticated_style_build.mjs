...
// Purge the critical stylesheet against first-paint surfaces only. Component
// bridges and channel/system panels are loaded after first paint together with
// the complete authenticated stylesheet, so scanning them here would pull
// deferred selectors back into the startup payload.
export const FRONTEND_AUTHENTICATED_STARTUP_STYLE_CONTENT_PATHS = Object.freeze([
  'index.html',
  'app-main.js',
  'compass-static.js',
  'home-static.js',
