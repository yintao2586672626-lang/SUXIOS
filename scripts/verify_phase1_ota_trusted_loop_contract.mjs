...
requireIncludes('scripts/scan_p0_ota_traffic_payload_candidates.mjs', 'P0 traffic payload scanner is dry-run only and payload-safe', [
  ...
  'summarizeTrafficEvidenceDiagnostics',
  'evidence_source_path_rows',
  'evidence_structured_source_path_rows',
  'evidence_raw_data_field_facts_rows',
  'evidence_raw_data_exposed_rows',
  'evidence_sensitive_value_rows',
...
requireIncludes('scripts/verify_p0_ota_field_loop_closure.php', 'P0 verifier exposes traffic evidence availability without sensitive values', [
  ...
  'p0_required_traffic_ui_status',
  'p0_required_traffic_metrics',
  'field_loop_matrix',
  'p0_standard_fact_summary',
  'standard_fact_status',
  ...
  'Traffic Field Loop Matrix',
  'p0_traffic_field_loop_matrix_index',
  ...
  'platforms_ready counts platforms whose p0_traffic_gate is ready',
  ...
  'row_source_path_missing',
  'row_source_path_structured_not_true',
  'raw_data_field_facts_present_not_true',
  'raw_data_exposed_not_false',
  'row_source_path_rows',
  'row_source_path_structured_rows',
  'raw_data_field_facts_rows',
  'raw_data_exposed_rows',
  'external_evidence_row_source_path_rows',
  'external_evidence_row_source_path_structured_rows',
  'external_evidence_raw_data_field_facts_rows',
  'external_evidence_raw_data_exposed_rows',
  ...
  'p0_hotel_scoped_payload_evidence_diagnostics',
  ...
  'manual_login_state_verified',
  'traffic_current_session_verified_count',
  'traffic_profile_binding_ready_count',
  'current_session_probe_verified_on_same_data_source',
  'historical_metadata_only',
  'ready_for_session_probe',
...
requireIncludes('scripts/register_p0_ota_traffic_data_sources.php', 'P0 traffic source registration stays explicit and non-sensitive', [
  ...
  'Historical Profile metadata and directory presence are preparation evidence only; current-session proof must be produced on this same data source before sync.',
  'registered sources stay waiting_config and ready_for_session_probe',
  'profile_contexts_for_hotels',
  'not_required_for_browser_profile',
  'profile_session_metadata_only_no_vault_decrypt',
  'matched_profile_metadata_count',
]);
requireExcludes('scripts/register_p0_ota_traffic_data_sources.php', 'P0 traffic source registration must not preserve success as target status', [
  ...
  '$credentialResolution = credential_contexts_for_hotels($platform, $hotelIds);',
  'find_verified_profile_login_source',
  'apply_profile_login_inheritance',
