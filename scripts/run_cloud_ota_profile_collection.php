...
$validated = (new CloudBrowserProfileService())->validateOtaCollectionProfile(
    $profileId,
    $sourceId,
    $tenantId,
    $hotelId,
...
try {
    ...
    if ($collectionSessionId !== null) {
        try {
            gatewayRequest($gatewayUrl, $controlToken, '/v1/collection/close', [
            ...
            // The primary result remains truthful; gateway timeout still seals the Profile.
        }
    }
}
