...
- Current self-audit: full directory about `298.95 MB`, without `.git` about `92.66 MB`, without `.git` and dependencies about `63.47 MB`, tracked files about `18.53 MB` / `613` files; code scope `369` files, `194347` total lines, and `178481` nonblank lines; cleanup candidates `0 MB`.
