...
const SUXI_CSP_REPORT_ONLY = "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'self'; form-action 'self'; script-src 'self' 'sha256-sGmHtz3c5oX2Qt7Y8ows2buHFKo+q72CzwRiUl1Q3HQ=' 'sha256-91DDEd5d63aSS7LsD1SzXAGbNKYTGJ6imIeBQ8xk8VA=' 'sha256-LVv/26o2w7ZGbEFyp2a1eeKNc3cZnV/P5lalHh3/N3s='; script-src-attr 'none'; style-src 'self'; img-src 'self' data:; font-src 'self' data:; connect-src 'self'; frame-src 'self'; media-src 'self'; worker-src 'self'; manifest-src 'self'";
